        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConversationTopics_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Invoices", x => new { x.UserId, x.ActivityId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResidenceDatas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ResidenceDatas_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Notifications", x => new { x.UserId, x.NotificationTypeId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ServicesStatusId = table.Column<int>(type: "int", nullable: false),
                    ServiceStatusId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServicesT", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CoversationTopicId = table.Column<int>(type: "int", nullable: false),
                    ConversationTopicId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Commentaries_ConversationTopics_ConversationTopicId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvoiceUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    InvoiceActivityId = table.Column<int>(type: "int", nullable: false),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DepositNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Amount = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Payments", x => new { x.InvoiceId, x.TypePaymentId });
                    table.ForeignKey(
                        name: "FK_Payments_Invoices_InvoiceUserId_InvoiceActivityId",
                        columns: x => new { x.InvoiceUserId, x.InvoiceActivityId },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Commentaries_ConversationTopicId",
                table: "Commentaries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConversationTopics_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResidenceDatas_UserId",
                table: "ResidenceDatas",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ServicesT_ServiceStatusId",
                table: "ServicesT",
